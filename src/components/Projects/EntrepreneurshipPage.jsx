...
export default function EntrepreneurshipPage() {
  ...
  // const project = entrepenurshipDetails.find((p) => p.slug === slug);
  const project = entrepenurshipDetails?.find((company) =>
    company.projects?.some((project) => project.slug === slug)
  );
  console.log(project)

  const projectData = project.projects.find((p) => p.slug === slug); 
                ...
                <motion.div className="main_projects"
                    ...
                    <div className="project_details" >
                        ...
                        <motion.div className="features" whileInView={{ y: 0, opacity: 1 }}
                            ...
                            <h2>Key Features</h2>
                            <ul>
                  {projectData.achievements.map((point, i) => (
                    <li key={i}>{point}</li>
                  ))}
